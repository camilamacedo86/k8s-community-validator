...
// K8S community validator the bundle manifests against the required and specific criteria to publish
...
var K8sCommunityValidator interfaces.Validator = interfaces.ValidatorFunc(k8sCommunityValidator)
...
func k8sCommunityValidator(objs ...interface{}) (results []errors.ManifestResult) {
...
// K8sCommunityValidatorChecks defines the attributes used to perform the checks
type K8sCommunityValidatorChecks struct {
...
func validateK8sCommunityBundle(bundle *manifests.Bundle) errors.ManifestResult {
	...
	checks := K8sCommunityValidatorChecks{bundle: *bundle, errs: []error{}, warns: []error{}}
...
func checkMaxKubeVersionAnnotation(checks K8sCommunityValidatorChecks) K8sCommunityValidatorChecks {
